...
export const metadata: Metadata = {
  title: "Events",
  description:
    "Explore upcoming worship services, conferences, and community gatherings at Yetinsaie Hayil Church.",
  alternates: {
    canonical: "/events",
  },
  keywords: ["events", "worship", "conference", "community", "Paris"],
};
export default function EventsPage() {
  const events = [
    ...
    },
    {
      ...
      time: "15:00 PM - 18:00 PM",
      location: "Main church",
      description: "An evening of worship, teaching, and fellowship ",
      recurring: false,
      image: "/conf2.jpg",
    },

    {
      ...
      time: "15:00 PM - 18:00 PM",
      location: "Church",
      description: "worship, teaching, and fellowship",
      recurring: false,
      image: "/conf1.jpg",
    },
  ];
  ...
  return (
    <main className="flex-1 min-h-screen bg-gradient-to-b">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {event.recurring && (
                            <span className="px-2 py-1 text-xs rounded-md bg-accent/20 text-accent-foreground"></span>
                          )}
                        </div>
