...
export const metadata: Metadata = {
  ...
  description:
    "Read the core beliefs and doctrinal foundations of Yetinsaie Hayil Church.",
  alternates: {
    canonical: "/statement-of-faith",
  },
  keywords: ["statement of faith", "beliefs", "doctrine", "church"],
};
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div>
              <ol className="list-decimal pl-4 space-y-4 text-muted-foreground leading-relaxed">
                ...
                <li>
                  ጌታችን ኢየሱስ ክርስቶስ ለሰው ልጆች ቤዛ ሆኖ በመስቀል ላይ መሞቱን፣ መቀበሩን፣ በሶስተኛው ቀን
                  በአካል ከሙታን መነሳቱን፣ ወደ አብ ቀኝ ማረጉን፣ አሁንም ለእኛ እንደሚማልድ እናምናለን፤ ደግሞም
                  በሕያዋንና በሙታን ላይ ሊፈርድ እንደሚመለስ እናምናለን፡፡
                </li>

                <li>
                  ሰው በእግዚአብሔር አምሳል መፈጠሩን፣ ነገር ግን በሃጢአት በመውደቁ ምክንያት የእግዚአብሔር ቁጣና
                  ፍርድ ያለበት በደለኛ መሆኑን እናምናለን፡፡
                </li>

                <li>
                  ሰው ከሃጢአት ሃይልና ቅጣት ሊድን የሚችለው ሃጢአት የሌለበት የእግዚአብሔር ልጅ ኢየሱስ ክርስቶስ
                  የሰው ምትክ ሆኖ በፈጸመው የቤዛነት ስራ ብቻ መሆኑን፣ ሰውም በእግዚአብሔር ፀጋ በኢየሱስ ክርስቶስ
                  በማመን ብቻ እንደሚጸድቅ እናምናለን፡፡
                </li>
                ...
                <li>
                  ሰው በጌታ በኢየሱስ ክርስቶስ አምኖ ንሰሐ በገባ ጊዜ በክርስቶስ ሞትና ትንሳኤ መተባበሩን ለመግለጽ
                  በአብ፣ በወልድ፣ በመንፈስ ቅዱስ ስም በውሃ ውስጥ በመጥለቅ እንዲጠመቅ እንደሚገባና፣ ጌታ እስኪመጣ
                  ድረስ ሞቱን ለመናገር እና ከምዕመናን ጋር ያለውን ሕብረት ለመግለጽ የጌታን እራት እንደሚካፈል
                  እናምናለን፡፡
                </li>

                <li>
                  መንፈስ ቅዱስ በአማኝ ሕይወት ውስጥ እንደሚኖር እናምናለን፤ አማኙ በመንፈስ ቅዱስ ሲጠመቅ ሃይልን
                  እንደሚቀበልና በልሳን እንደሚናገር፣ በየጊዜውም በመንፈስ ቅዱስ እንደሚሞላ እናምናለን፡፡
                </li>
